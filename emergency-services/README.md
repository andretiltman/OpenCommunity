...
This directory stores emergency services contacts for your community
(police, fire, medical, etc.).

Each entry is a single JSON file inside [`contacts/`](./contacts), named after
the service (lowercase, hyphen-separated), e.g. `contacts/central-police.json`.
...
that cover your whole community (e.g. municipal electricity lines).
